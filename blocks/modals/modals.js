...
import { isPlaceFavorite, togglePlaceFavorite } from '../../scripts/utils/favorites.js';
import { getPeriodName, getTypeName } from '../../scripts/utils/utils.js';
import { normalizeImagePath } from '../../scripts/utils/data.js';
function setupModals() {
  const closeSelectors = ['.modal .close', '.modal .modal__close'];
  ...
  try {
    ...
    if (active && modal.contains(active)) {
      ...
      if (_lastFocusedElement && document.contains(_lastFocusedElement)) {
        try { _lastFocusedElement.focus(); } catch (e) { document.body.focus(); }
      } else {
