import { appState, loadPlacesData, normalizeImagePath } from '../utils/data.js';
import { getFavorites, saveFavorites, togglePlaceFavorite, toggleRouteFavorite, isPlaceFavorite, isRouteFavorite } from '../utils/favorites.js';
import { showError, getPeriodName, getTypeName } from '../utils/utils.js';
import { cityTravelTimes } from '../utils/constants.js';
...
import { renderObjectGrid, createObjectCardHTML, setupObjectCardHandlers } from '../../blocks/cards/cards.js';
import { setupModals, openModal, closeModal, openObjectModal, handleObjectAction, openCompareModal, openSingleImageModal } from '../../blocks/modals/modals.js';
import { setupMapInteractions, setupMapInteractionsRoutes, setupHideMapButton, filterMapZones, highlightPlaceOnMap, getMapCoordinates, setupMapModal, setupMapModalRoutes } from '../../blocks/map-svg/map-svg.js';
import { buildGallery, setCurrentGalleryIndex, updateGalleryNavButtons, openGalleryByOffset, attachMapFocusHandler, attachDetailsHandler } from '../../blocks/gallery/gallery.js';
import { focusPlaceOnMap, checkAndFocusPlaceOnLoad } from '../../blocks/navigation/navigation.js';
import { buildStats, openPeriodModal } from '../../blocks/stats/stats.js';
import { initApp } from '../init/init.js';
window.appState = appState;
function syncPlacesToWindow() {
